$(function(){
		...
		$.ajax({
			...
			success:function(param){
				...
				$(param.list).each(function(index,item){
					...
					//로그인한 회원번호와 댓글 작성자의 회원번호 일치 여부 체크
	...
	$(document).on('click','.modify-btn',function(){
		...
		//숨겨져 있는 div(class=sub-item)을 복구시키고 수정폼을 초기화함(제거)
		initModifyForm();
		
		//지금 클릭해서 수정하고자 하는 댓글 데이터는 감추기
		//수정버튼을 감싸고 있는 div
		$(this).parent().hide();
